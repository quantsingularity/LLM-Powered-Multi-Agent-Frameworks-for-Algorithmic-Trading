...
class RLTrainer:
    ...
    def _create_model(self):
        ...
        if self.algorithm_name == "PPO":
            return PPO(self.policy, self.env, **self.hyperparams)
        elif self.algorithm_name == "DQN":
            return DQN(self.policy, self.env, **self.hyperparams)
        elif self.algorithm_name == "A2C":
            return A2C(self.policy, self.env, **self.hyperparams)
        else:
    ...
    def train(
        ...
        return {"total_timesteps": total_timesteps, "save_dir": self.save_dir}
