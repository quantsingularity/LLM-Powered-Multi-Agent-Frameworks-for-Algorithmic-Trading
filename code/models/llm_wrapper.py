...
class LLMWrapper:
    ...
    def _init_anthropic(self):
        ...
        logger.info(f"Initialized Anthropic backend with model {self.config.model_name}")
    ...
    def _generate_openai(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
    ...
    def _generate_anthropic(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
        """Generate using Anthropic API."""
        system = system_prompt or "You are a helpful AI assistant for financial trading."
    ...
    def _generate_local(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
    ...
    def _generate_mock(self, prompt: str, system_prompt: Optional[str], **kwargs) -> str:
...
if __name__ == "__main__":
    ...
    response = llm.generate(
        prompt=prompt,
        system_prompt=template.SYSTEM_PROMPTS["analyst"]
    )
